  ...
  return ( 
    <nav className="sticky top-0 z-50 flex items-center justify-between py-4 bg-transparent backdrop-blur-sm px-8">
      ...
      <div className="flex items-center h-16 gap-6 mr-6">
        {/* LinkedIn (hidden on small screens, shown on md+) */}
        <a 
          href="https://www.linkedin.com/in/khaled-elfaham/" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="hidden md:block text-white hover:text-blue-400 transition-all duration-300 transform hover:scale-110"
        >
          <FaLinkedin size={32} />
        </a>
        ...
        <a 
          href="https://www.instagram.com/khaledmnms/" 
          target="_blank" 
          rel="noopener noreferrer" 
